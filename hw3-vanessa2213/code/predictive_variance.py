# ISTA 421 / INFO 521 Fall 2021, HW 3, Exercises 5 and 6
...
def calculate_prediction_variance(x_new, X, w, t):
    ...
    D = X.shape[1]  #columns
    sigma_2 = ((1.0/(N))*(numpy.dot(t.T,t)-numpy.dot((numpy.dot(t,X)),w)))/(1-D/N) #it is biased = sigma_or(1-D/N) therefore to remove it diviade by (1-D/N)
