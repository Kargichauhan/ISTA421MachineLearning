# ISTA 421 / INFO 521 Fall 2021 HW 2, Exercise 3
...
DATA_ROOT = '../data'
DATA_SYNTH2021 = os.path.join(DATA_ROOT, 'synthdata2021.csv')

FIGURES_ROOT = '../figures'
PATH_TO_SYNTH_5FOLDCV_FIG = os.path.join(FIGURES_ROOT, 'synthetic2021-5fold-CV.png')
PATH_TO_SYNTH_LOOCV_FIG = os.path.join(FIGURES_ROOT, 'synthetic2021-LOOCV.png')
PATH_TO_SYNTH_5FOLDCV_FIG_2 = os.path.join(FIGURES_ROOT, 'synthetic2021-5fold-CV-2.png')
PATH_TO_SYNTH_LOOCV_FIG_2 = os.path.join(FIGURES_ROOT, 'synthetic2021-LOOCV_2.png')
...
# NOTE: The following is only used in the demo example code.
...
def ex3_5_fun (K, maxorder, x, t, randomize_data=False, title='CV', save_path=None):
    """
    Implements the core of the cross-validation demonstration
    from FCML Ch 1, pp.31-32.
    :param K: Number of folds
...
def exercise_3_5fold(data_path, figure_path, seed):
    ...
    best_poly, min_mean_log_cv_loss, w = \
        ex3_5_fun( K, 7, x, t, True, f'{K}-fold CV' , figure_path)
    plot_data_and_model(x, t, w)
    #plt.savefig(PATH_TO_SYNTH_5FOLDCV_FIG_2, format='png') #to save the plot
    #print(w)
    ### YOUR CODE HERE
    # Perform 5-fold cross-validation:
    # Calculate the best polynomial model order as k5_best_poly
    k5_best_model_order = best_poly
    #print(k5_best_model_order)
...
def exercise_3_LOOCV(data_path, figure_path_LOOCV, seed):
    ...
    #print(K)
    best_poly, min_mean_log_cv_loss, w = \
        ex3_5_fun( K, 7, x, t, True, f'{K}-fold CV' , figure_path_LOOCV)
    plot_data_and_model(x, t, w)
    #plt.savefig(PATH_TO_SYNTH_LOOCV_FIG_2, format='png')#just to safe the plot
    ### YOUR CODE HERE
...
if __name__ == '__main__':
    ...
    if RUN_EXERCISE_3_5FOLD:
        exercise_3_5fold(DATA_SYNTH2021, PATH_TO_SYNTH_5FOLDCV_FIG, seed=29)
        plt.show()
    if RUN_EXERCISE_3_LOOCV:
        exercise_3_LOOCV(DATA_SYNTH2021, PATH_TO_SYNTH_LOOCV_FIG, seed=29)
        plt.show()
